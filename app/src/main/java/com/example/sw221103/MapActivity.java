...
public class MapActivity extends AppCompatActivity implements OnMapReadyCallback, ActivityCompat.OnRequestPermissionsResultCallback {
    ...
    private boolean isRegisteredLocationCallback = false;
    ...
    private final LocationCallback locationCallback = new LocationCallback() {
        ...
        public void onLocationResult(LocationResult locationResult) {
            ...
            if (locationList.size() > 0) {
                ...
                //현재 위치에 마커 생성하고 이동
                // 화면을 이동해도 자신의 위치로 되돌아 가는 것은 아래 함수 때문
    ...
    private void startLocationUpdates(boolean withAlertDialog) {
        if (!checkLocationServicesStatus()) {
            ...
            if (checkPermission()) {
                if (!isRegisteredLocationCallback) {
    ...
    private void setDefaultLocation() {
        //디폴트 위치, 상주
        LatLng DEFAULT_LOCATION = new LatLng(36.3784, 128.1452);
